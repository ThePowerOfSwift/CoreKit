...
public extension AppleColor
{
    ...
    public func blendRGB(color: AppleColor) -> AppleColor {
        ...
        let div = sqrt(sqrt(CGFloat(colors.count)))
    ...
    public func blendRGBBetween(color: AppleColor, steps: Int) -> [AppleColor] {
        ...
        let elements = stride(from: 2, to: steps-1, by: 1).map { return self.blendRGB(color: color, blendValue: stepSize*CGFloat($0)) }
